...
const quizData = {
  sections: [
      ...
      questions: [
        {
          ...
          options: [
            {
              text: "Hardly notice—just adapt smoothly",
              note: "Very Low ε",
              value: 1,
            },
            { text: "Notice but adapt quickly", note: "Low ε", value: 2 },
            {
              text: "Feel disrupted, need to recalibrate",
              note: "Moderate ε",
              value: 3,
            },
            {
              text: "Strong reaction—feels like system failure",
              note: "High ε",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            ...
            {
              text: "Sometimes notice obvious ones",
              note: "Moderate-Low ε",
              value: 2,
            },
            {
              text: "Frequently notice subtle mismatches",
              note: "Moderate-High ε",
              value: 3,
            },
            {
              text: "Constantly—my brain flags inconsistencies",
              note: "Very High ε",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            {
              text: "Hardly notice errors—keep going",
              note: "Low ε",
              value: 1,
            },
            {
              text: "Notice but don't dwell on errors",
              note: "Moderate ε",
              value: 2,
            },
            {
              text: "Errors feel significant—motivate correction",
              note: "High ε",
              value: 3,
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Notice only large discrepancies",
              note: "Moderate-Low ε",
              value: 2,
            },
            {
              text: "Quickly detect subtle incongruences",
              note: "Moderate-High ε",
              value: 3,
            },
            {
              text: "Immediately sense any mismatch",
              note: "Very High ε",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            {
              text: "Mostly comforting routine preferred",
              note: "Low ε",
              value: 1,
            },
            {
              text: "Enjoy some novelty in moderation",
              note: "Moderate ε",
              value: 2,
            },
            { text: "Seek novelty—it's energizing", note: "High ε", value: 3 },
            {
              text: "Need constant novelty—routine feels stifling",
              note: "Very High ε",
              value: 4,
            },
          ],
      ...
      questions: [
        {
          ...
          options: [
            {
              text: "Probably nothing—ignore it",
              note: "Low body precision",
              value: 1,
            },
            {
        ...
        },
        {
          ...
          options: [
            {
              text: "To potential opportunities",
              note: "High reward precision",
              value: 1,
            },
            {
              text: "To gathering more information",
              note: "Balanced precision",
              value: 2,
            },
            {
              text: "To potential problems or threats",
              note: "High threat precision",
              value: 3,
            },
            {
        ...
        },
        {
          ...
          options: [
            {
              text: "Minimal—I trust my own judgment",
              note: "Low social precision",
              value: 1,
            },
            {
              text: "Consider but don't overvalue",
              note: "Moderate social precision",
              value: 2,
            },
            {
              text: "Strongly influence my choices",
              note: "High social precision",
              value: 3,
            },
            {
              text: "Often override my own judgment",
              note: "Very high social precision",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            ...
            {
              text: "Mostly logic with some intuition",
              note: "Moderate balance",
              value: 2,
            },
            {
              text: "Equal weight to both",
              note: "Balanced precision",
              value: 3,
            },
            {
              text: "Intuition guides, logic confirms",
              note: "High intuitive precision",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            {
              text: "Slowly—prefer to stay uncertain",
              note: "Low confidence precision",
              value: 1,
            },
            {
              text: "Moderately—after some consideration",
              note: "Moderate confidence",
              value: 2,
            },
            {
              text: "Fairly quickly with moderate confidence",
      ...
      questions: [
        {
          ...
          options: [
            {
              text: "Almost never—deeply absorbed",
              note: "Very High θₜ",
              value: 4,
            },
            { text: "Only loud or salient sounds", note: "High θₜ", value: 3 },
            {
              text: "Moderate sounds break through",
              note: "Moderate θₜ",
              value: 2,
            },
        ...
        },
        {
          ...
          options: [
            {
              text: "Just one or two focused elements",
              note: "High θₜ",
              value: 4,
            },
            {
              text: "A few related elements",
              note: "Moderate-High θₜ",
              value: 3,
            },
            {
              text: "Several different elements",
              note: "Moderate-Low θₜ",
              value: 2,
            },
        ...
        },
        {
          ...
          options: [
            {
              text: "Often miss until emotions are strong",
              note: "High θₜ",
              value: 1,
            },
            {
              text: "Notice moderate emotional shifts",
              note: "Moderate-High θₜ",
              value: 2,
            },
            {
              text: "Notice subtle emotional fluctuations",
              note: "Moderate-Low θₜ",
              value: 3,
            },
            {
              text: "Immediately aware of slightest shifts",
              note: "Low θₜ",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            {
              text: "Very little—I focus selectively",
              note: "High θₜ",
              value: 4,
            },
            {
            ...
            {
              text: "Quite a lot of environment",
              note: "Moderate-Low θₜ",
              value: 2,
            },
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Fairly easily when conditions right",
              note: "Moderate-High θₜ",
              value: 3,
            },
            {
              text: "Occasionally with effort",
              note: "Moderate-Low θₜ",
              value: 2,
            },
    ...
    },
    {
      ...
      subtitle:
        "Whether your awareness anchors primarily in bodily sensations or external events",
      ...
      questions: [
        {
          ...
          options: [
            {
              text: "Mostly as thoughts about emotion",
              note: "Very Low β",
              value: 1,
            },
            {
              text: "Some physical sensation but mostly thoughts",
              note: "Low β",
              value: 2,
            },
            {
              text: "Equal physical sensations and thoughts",
              note: "Moderate β",
              value: 3,
            },
            {
              text: "Overwhelmingly as physical sensations",
              note: "High β",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            ...
            {
              text: "Mostly logic with some gut feeling",
              note: "Moderate-Low β",
              value: 2,
            },
            {
              text: "Equal logic and bodily intuition",
              note: "Moderate-High β",
              value: 3,
            },
            {
              text: "Bodily feeling of rightness/wrongness",
              note: "High β",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            {
              text: "Rarely notice unless pointed out",
              note: "Low β",
              value: 1,
            },
            {
              text: "Occasionally notice when resting",
              note: "Moderate-Low β",
              value: 2,
            },
            {
              text: "Frequently aware throughout day",
              note: "Moderate-High β",
              value: 3,
            },
            {
              text: "Constantly aware of multiple signals",
              note: "High β",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            {
              text: "Worried thoughts and mental analysis",
              note: "Low β",
              value: 1,
            },
            {
              text: "Mostly thoughts with some body tension",
              note: "Moderate-Low β",
              value: 2,
            },
            {
              text: "Equal mental and physical symptoms",
              note: "Moderate β",
              value: 3,
            },
            {
              text: "Overwhelming physical sensations",
              note: "High β",
              value: 4,
            },
          ],
        },
        {
          ...
          options: [
            ...
            {
              text: "Mostly mental with slight bodily sense",
              note: "Moderate-Low β",
              value: 2,
            },
            {
              text: "With clear bodily correlates",
              note: "Moderate-High β",
              value: 3,
            },
            {
              text: "As distinct bodily experiences",
              note: "High β",
              value: 4,
            },
          ],
